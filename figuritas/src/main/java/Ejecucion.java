...
public class Ejecucion {
    public static void main(String[] args) {
        ...
        int opcion = 0;
        System.out.println("Bienvenido! , ingrese 1 para entrar al modulo de escaleno\n2.para el modulo de heptagono\n3.para el modulo de octagono");
        opcion = s.nextInt();
        switch(opcion){
            case 1: System.out.println("Ingrese la medida de la base del escaleno");
            ...
            case 2:System.out.println("Ingrese la medida del apotema del heptagono");
            ...
            case 3:System.out.println("Ingrese la medida del apotema del Octagono");
            ...
            default: System.out.println("no especifico una opcion valida");break;
        }
        s.close();
    }
}
